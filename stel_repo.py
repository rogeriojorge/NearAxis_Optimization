...
def get_stel(ind,nphi=251):
    ...
    if ind==13:
        ...
        rc     = [ 1.0,-0.1594071426561219,0.010813296724974003,-0.0005030613118669596,5.184921130609196e-05,-1.1713877965171314e-05,5.300125676567709e-06,-1.3872966973716954e-06 ]
        zs     = [ 0.0,0.14450064193895193,-0.011022463757098724,-0.00021656942268761286,0.0002086913365175538,-4.704687512960267e-05,1.0321408883154643e-05,-1.835877075195317e-06 ]
        etabar =  0.5993772775919141
        nfp    =  2
        B2c    =  -1.6729883286973846
        p2     =  -500000.0
        iota   =  0.40713198128641104
        stel   =  make_optimizable(Qsc(rc=rc, zs=zs, etabar=etabar, nfp=nfp, nphi=nphi, B2c=B2c, order='r3', p2=p2))
        r_edge =  1/14
        coilSeparation = 0.1
        targetValue = 0.08
        nCoilsPerNFP = 6
        # DMerc mean  =  0.04253748557781853
        # DWell mean  =  0.19142021993064323
        # Max elongation  =  5.11362229356336
        # B20 variation = 0.5137544095495947
        # Max |X20| = 2.835212370925697
        # Max |X3c1| = 0.5812134972172133
        # gradgradB inverse length:  2.457789644361698
        # objective function:  13812.591068690643
