...
def get_stel(ind,nphi=251):
    ...
    if ind==10:
        name   = 'QH_NFP5_vac'
        rc     = [ 1.0,0.15230932218554147,0.013157751477872747,0.0005005474766297447,-8.207600936246827e-05,-1.9031830833002136e-05,-1.5908272436524292e-06, 1e-8 ]
        zs     = [ 0.0,0.14162848581587018,0.012463917556218515,0.00046988142095840817,-8.194435803028256e-05,-1.968263328477221e-05,-2.1312049049249833e-06, 1e-8 ]
        etabar =  2.447727452622748
        nfp    =  5
        B2c    =  -0.22565885565966273
        p2     =  0.0
        iota   =  -1.302123523621343
        stel   =  make_optimizable(Qsc(rc=rc, zs=zs, etabar=etabar, nfp=nfp, nphi=nphi, B2c=B2c, order='r3', p2=p2))
        r_edge =  1/6
        coilSeparation = 0.15
        targetValue = 0.08
        ...
        # DMerc mean  =  0.0
        # DWell mean  =  0.0
        # Max elongation  =  2.28184230804999
        # B20 variation = 0.06491564163101127
        # Max |X20| = 0.6690754458185929
        # Max |X3c1| = 0.32562958273958875
        # gradgradB inverse length:  3.1077730193258373
        # objective function:  1160.5918267369052
