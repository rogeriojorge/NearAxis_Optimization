...
def get_stel(ind,nphi=251):
    ...
    if ind==11:
        name   = 'QH_NFP5_plasma'
        rc     = [ 1.0,0.15222483345743512,0.008642939860311375,-0.001528645358612831,-0.0003459957233202585,1.1655721389921072e-05,1.1307568806314472e-05,9.118071743105138e-07 ]
        zs     = [ 0.0,0.12530111270981323,0.007678983189607204,-0.0013127141300785447,-0.0003164361498579385,9.63134476543573e-06,1.0769685728506038e-05,3.849811197958665e-07 ]
        etabar =  2.7891310589370244
        nfp    =  5
        B2c    =  0.34376247395848925
        p2     =  -1000000.0
        iota   =  -1.4678515920911035
        stel   =  make_optimizable(Qsc(rc=rc, zs=zs, etabar=etabar, nfp=nfp, nphi=nphi, B2c=B2c, order='r3', p2=p2))
        r_edge =  1/6
        coilSeparation = 0.15
        targetValue = 0.08
        nCoilsPerNFP = 4
        # DMerc mean  =  0.013100004713289648
        # DWell mean  =  0.5555404893709254
        # Max elongation  =  2.499337650393811
        # B20 variation = 0.06979527770148053
        # Max |X20| = 3.3570472647059626
        # Max |X3c1| = 0.9251213545196154
        # gradgradB inverse length:  5.071049978968746
        # objective function:  3353.418792223191
