...
def get_stel(ind,nphi=251,r_edge=0.06,coilSeparation = 0.1,targetValue = 0.08,nCoilsPerNFP = 6):
    ...
    if ind==26:
        ...
        zs      = [ 0.0,0.0,-0.41123539809579074,0.0,0.005584241966671795,0.0,-0.0014835667051837215,0.0,-0.0025689485424969117,0.0,0.00040809533749352236,0.0,-0.0002984514059745055 ]
        B0_vals = [ 1.0,-0.12514937480085025 ]
        d_svals = [ 0.0,1.1820950091144147,0.2553523536503558,0.1359969887863265,0.006399784106318229,0.015355437095495928,-0.004831497283461862 ]
        delta   = 1.0680559482662593
        nfp     = 1
        B2s_svals = [ 0.0,10.81088561085788,-0.5917728546348221,2.0434300406247567,-2.540816918220208,-0.19734322931120551,-0.051883206097879844 ]
        p2      =  0.0
        ...
        iota    =  -0.5930923070300284
        # DMerc mean  = 0.0
        # DWell mean  = 0.0
        # DGeod mean  = 0.0
        # B20 variation = 3.946196920649328
        # B20 mean = 0.151730179821773
        # Max |X20| = 90.1728476263597
        # gradgradB inverse length: 23.87415996485215
        # d2_volume_d_psi2 mean =, -29.75156163841198
        # mean gradB inverse length: 3.525799019808983
        # Max elongation = 7.019720602190991
        # objective function:  1138556.1458374395
    try:
        stel.omn
    except:
        stel.omn = False
