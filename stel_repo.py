...
def get_stel(ind,nphi=251,r_edge=0.06,coilSeparation = 0.1,targetValue = 0.08,nCoilsPerNFP = 6):
    ...
    if ind==24:
        ...
        zs     = [ 0.0,0.0,-0.020756500760878982,0.0,-0.0008133444997626577,0.0,-0.00010266156806053156,0.0,-7.833618675759693e-05,0.0,-6.830222503093403e-08,0.0,0.0 ]
        B0_vals = [ 1.0,0.18055331627679858 ]
        d_svals = [ 0.0,0.8695846968108517,0.003696438615168289,-0.01187047071763437,0.019935022513604364,-1.186044353014955e-12,0.0 ]
        delta   = 0.35219143844040957
        nfp     = 2
        stel    =  make_optimizable(Qsc(rc=rc,zs=zs, nfp=nfp, B0_vals=B0_vals, d_svals=d_svals, nphi=nphi, omn=True, delta=delta))
        iota   =  -3.1723485030945158
        # mean gradB inverse length: 8.20559180058168
        # Max elongation = 6.632310684842806
        # objective function:  410.48156404398884
    try:
        stel.omn
    except:
        stel.omn = False
