...
def get_stel(ind,nphi=251,r_edge=0.06,coilSeparation = 0.1,targetValue = 0.08,nCoilsPerNFP = 6):
    ...
    if ind==24:
        ...
        zs      = [ 0.0,0.0,0.03838080266127426,0.0,0.0007609494955475468,0.0,4.7528957431579056e-05,0.0,-2.0067454268134847e-05 ]
        B0_vals = [ 1.0,0.15237249558059462 ]
        d_svals = [ 0.0,1.064067482169502,0.0021743843810376087,-2.133110773077656e-06,3.4435080174013787e-06 ]
        delta   = 0.6167000778788022
        nfp     = 2
        stel    =  make_optimizable(Qsc(rc=rc,zs=zs, nfp=nfp, B0_vals=B0_vals, d_svals=d_svals, nphi=nphi, omn=True, delta=delta))
        iota    =  3.0968741865475304
        # mean gradB inverse length: 2.2220648656646107
        # Max elongation = 4.780693683882591
        # objective function:  386.1442603037338
    if ind==25:
        name   = 'QI_NFP3_r1'
