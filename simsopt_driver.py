...
def optimize(stel,iota_target=0.41,rel_step_array=[1e-2],abs_step_array=[1e-2],nIterations=20,grad=False):
    ...
    term = [
            (stel, 'iota', iota_target, 6e3),
            #(stel, 'p2', 0.0, 1e-1),
            (stel, 'max_elongation', 0.0, 5e-1),
            (stel, 'elongation', 0.0, 2e-2),
            (stel, 'B20_anomaly', 0.0, 2e3),
            (stel, 'B20_variation', 0.0, 2e4),
            (stel, 'X20', 0.0, 1e-1),
            (stel, 'X2c', 0.0, 1e-1),
            (stel, 'X2s', 0.0, 1e-1),
            (stel, 'Y20', 0.0, 1e-1),
            ...
            (stel, 'Z2c', 0.0, 1e-1),
            (stel, 'Z2s', 0.0, 1e-1),
            # (stel, 'DMerc_times_r2', 1e+0,1e-0),
            (stel, 'grad_grad_B_inverse_scale_length', 0.0,5e-3)
            ]
